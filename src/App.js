      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            >
              Tiny Horror Club is a collection of 10,000 tiny creatures that are here to send a chill down your spine. The artworks have 9 attributes. The number 9 is considered unlucky in Japan. Most of the arrtibutes have 13 values which is synonymous with bad luck. Tiny Horror Club is the first collection of the MillionNFTsClub collection by The Lucky Roon.
            </s.TextDescription>
            <s.SpacerLarge />
            <s.TextTitle
              style={{
            ...
            >
                          <StyledLink target={"_blank"} href={"https://twitter.com/tinyhorrorclub"}>
                {"Twitter"}
              </StyledLink>
            </s.TextDescription>
            <s.TextDescription
